...
- Name: items/items.spec.ts >> Items List View >> clicking an item opens detail with same ID
- Location: tests/items/items.spec.ts:82:7

# Error details

```
Error: Create work item failed (400): {"timestamp":"2026-07-15T13:42:56.248628621Z","error":"VALIDATION_ERROR","message":"priority: must be greater than 0"}
```
