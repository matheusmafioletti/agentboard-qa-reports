...
- Name: items/items.spec.ts >> Items List View >> tree view expands Feature to show child US, then expand US to show child Tasks
- Location: tests/items/items.spec.ts:104:7

# Error details

```
Error: Create work item failed (400): {"timestamp":"2026-07-15T13:43:05.709790792Z","error":"VALIDATION_ERROR","message":"priority: must be greater than 0"}
```
