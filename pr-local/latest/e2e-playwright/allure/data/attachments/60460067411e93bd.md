...
- Name: board/kanban-flow.spec.ts >> Kanban Board — Work Item Flow >> drag-and-drop moves card to target column and persists after reload
- Location: tests/board/kanban-flow.spec.ts:73:7

# Error details

```
Error: Create work item failed (400): {"timestamp":"2026-07-15T13:42:30.850950974Z","error":"VALIDATION_ERROR","message":"priority: must be greater than 0"}
```
