...
- Name: board/kanban-flow.spec.ts >> Kanban Board — Work Item Flow >> card displays display key, type badge and parent reference
- Location: tests/board/kanban-flow.spec.ts:153:7

# Error details

```
Error: Create work item failed (400): {"timestamp":"2026-07-15T13:42:38.933941822Z","error":"VALIDATION_ERROR","message":"priority: must be greater than 0"}
```
