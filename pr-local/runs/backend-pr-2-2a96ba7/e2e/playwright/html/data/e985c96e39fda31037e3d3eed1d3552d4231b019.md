...
- Name: items/items.spec.ts >> Items List View >> type filter shows only items of selected type; clearing shows all
- Location: tests/items/items.spec.ts:46:7

# Error details

```
Error: Create work item failed (400): {"timestamp":"2026-07-15T13:42:54.503239821Z","error":"VALIDATION_ERROR","message":"priority: must be greater than 0"}
```
