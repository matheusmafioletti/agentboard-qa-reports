...
- Name: board/kanban-flow.spec.ts >> Kanban Board — Work Item Flow >> clicking a card opens CardModal with correct title, type and status
- Location: tests/board/kanban-flow.spec.ts:203:7

# Error details

```
Error: Create work item failed (400): {"timestamp":"2026-07-15T13:42:48.589732610Z","error":"VALIDATION_ERROR","message":"priority: must be greater than 0"}
```
