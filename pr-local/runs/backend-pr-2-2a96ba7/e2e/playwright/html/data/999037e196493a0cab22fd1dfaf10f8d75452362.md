...
- Name: board/kanban-flow.spec.ts >> Kanban Board — Work Item Flow >> parent filter shows only tasks of selected user story; clearing shows all
- Location: tests/board/kanban-flow.spec.ts:95:7

# Error details

```
Error: Create work item failed (400): {"timestamp":"2026-07-15T13:42:37.606386994Z","error":"VALIDATION_ERROR","message":"priority: must be greater than 0"}
```
